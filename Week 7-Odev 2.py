import re
metin = ''' Without, the night was cold and wet, but in the small parlour of Laburnum villa the blinds were
...
siralama = r"\s\w{8}\s"
re.search(siralama, metin)
for match in re.findall(siralama, metin):
    print(match)
